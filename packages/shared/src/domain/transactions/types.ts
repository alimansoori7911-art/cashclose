...
export interface TransactionTypeDefinition {
  ...
  /**
   * توضیح الزامی است؟ (ستون «اجباری» جدول سند ورژن ۲)
   *
   * «الزامی» اینجا یعنی **هشدار**، نه مسدودسازی. اگر عکس اجباری جلوی
   * بستن صندوق را می‌گرفت، صندوقدار ساعت ۱۱ شب که اسکنر خراب است گیر
   * می‌کرد. به‌جایش صندوقدار باید بنویسد چرا نگذاشته، و حسابدار همان
   * دلیل را می‌بیند.
   */
  readonly requiresDescription: boolean;
  /** عکس الزامی است؟ همان قاعدهٔ بالا. */
